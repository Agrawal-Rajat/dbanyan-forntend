    ...
    <Box>
      ...
      <Group justify="space-between" mb="xl">
        ...
        <Group>
          ...
          <Button leftSection={<IconRefresh size={16} />} onClick={() => setUsers(mockUsers)}>
            Refresh
          </Button>
        </Group>
      </Group>
              ...
              <Table.Tbody>
                {paginatedUsers.map((user, index) => (
                  ...
                  >
                    ...
                    <Table.Td>
                      <Badge
                        color={userStatuses.find(s => s.value === user.status)?.color || 'gray'}
                        variant="light"
                        size="sm"
                      >
                    ...
                    <Table.Td>
                      <div>
                        <Text size="xs" c="dimmed">Login: {formatDate(user.last_login)}</Text>
